 ...
 *
 * User-facing instruction APIs are static inline in this header.
 *
 * Usage:
...
static inline void load_sqeargs_to_gsa(uint16_t gsa, uint16_t sqe)
{
...
static inline void load_sqeargs_to_xn(uint16_t xn, uint16_t sqe)
{
...
static inline void load_imd_to_gsa(uint16_t gsa, uint64_t imm)
{
...
static inline void load_imd_to_xn(uint16_t xn, uint64_t imm, uint16_t sec)
{
...
static inline void load_gsa_xn(uint16_t gsad, uint16_t gsam, uint16_t xn)
{
...
static inline void load_gsa_gsa(uint16_t gsad, uint16_t gsam, uint16_t gsan)
{
...
static inline void load_xx(uint16_t xd, uint16_t xm, uint16_t xn)
{
...
static inline void loop(uint16_t start, uint16_t end, uint16_t xn)
{
    ccu_v1_casm_loop(ctx_now(), start, end, xn);
}

static inline void loop_group(uint16_t start_loop, uint16_t xn, uint16_t xm, uint16_t hiperf)
{
...
static inline void set_cke(uint16_t clear, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void clear_cke(uint16_t clear, uint16_t clear_id, uint16_t clear_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void jmp(uint16_t dst_xn, uint16_t cond_xn, uint32_t expect)
{
...
static inline void trans_loc_mem_to_loc_ms(uint16_t ms, uint16_t gsa, uint16_t xn, uint16_t len_xn, uint16_t ch, uint16_t clear,
...
static inline void trans_rmt_mem_to_loc_ms(uint16_t ms, uint16_t gsa, uint16_t xn, uint16_t len_xn, uint16_t ch, uint16_t clear,
                             uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_loc_ms_to_loc_mem(uint16_t gsa, uint16_t xn, uint16_t ms, uint16_t len_xn, uint16_t ch, uint16_t clear,
                             uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_loc_ms_to_rmt_mem(uint16_t gsa, uint16_t xn, uint16_t ms, uint16_t len_xn, uint16_t ch, uint16_t clear,
                             uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_rmt_ms_to_loc_mem(uint16_t gsa, uint16_t xn, uint16_t ms, uint16_t len_xn, uint16_t ch, uint16_t clear,
                             uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_loc_ms_to_loc_ms(uint16_t dst_ms, uint16_t src_ms, uint16_t len_xn, uint16_t ch, uint16_t clear,
                            uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_rmt_ms_to_loc_ms(uint16_t loc_ms, uint16_t rmt_ms, uint16_t len_xn, uint16_t ch, uint16_t clear,
                            uint16_t len_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void trans_loc_ms_to_rmt_ms(uint16_t rmt_ms, uint16_t loc_ms, uint16_t len_xn, uint16_t ch, uint16_t rmt_set_id,
...
static inline void trans_rmt_mem_to_loc_mem(uint16_t loc_gsa, uint16_t loc_xn, uint16_t rmt_gsa, uint16_t rmt_xn, uint16_t len_xn,
...
static inline void trans_loc_mem_to_rmt_mem(uint16_t rmt_gsa, uint16_t rmt_xn, uint16_t loc_gsa, uint16_t loc_xn, uint16_t len_xn,
                              uint16_t ch, uint16_t udf, uint16_t reduce_dtype, uint16_t reduce_op, uint16_t clear,
                              uint16_t len_en, uint16_t reduce_en, uint16_t set_id, uint16_t set_mask, uint16_t wait_id,
                              uint16_t wait_mask)
{
...
static inline void trans_loc_mem_to_loc_mem(uint16_t dst_gsa, uint16_t dst_xn, uint16_t src_gsa, uint16_t src_xn, uint16_t len_xn,
...
static inline void sync_cke(uint16_t rmt_cke, uint16_t loc_cke, uint16_t loc_mask, uint16_t ch, uint16_t clear, uint16_t set_id,
...
static inline void sync_gsa(uint16_t rmt_gsa, uint16_t loc_gsa, uint16_t ch, uint16_t rmt_set_id, uint16_t rmt_set_mask,
...
static inline void sync_xn(uint16_t rmt_xn, uint16_t loc_xn, uint16_t ch, uint16_t rmt_set_id, uint16_t rmt_set_mask, uint16_t clear,
...
static inline void add(CcuMs ms, uint16_t count, uint16_t cast, uint16_t dtype, uint16_t len_xn, uint16_t clear, uint16_t set_id,
         uint16_t set_mask, uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void max(CcuMs ms, uint16_t count, uint16_t dtype, uint16_t len_xn, uint16_t clear, uint16_t set_id, uint16_t set_mask,
         uint16_t wait_id, uint16_t wait_mask)
{
...
static inline void min(CcuMs ms, uint16_t count, uint16_t dtype, uint16_t len_xn, uint16_t clear, uint16_t set_id, uint16_t set_mask,
         uint16_t wait_id, uint16_t wait_mask)
{
